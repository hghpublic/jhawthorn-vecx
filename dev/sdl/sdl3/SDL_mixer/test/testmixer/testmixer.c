// https://github.com/libsdl-org/SDL_mixer/blob/main/test/testmixer.c
...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
    ...
    { // it's safe to SDL_INIT_AUDIO, but MIX_Init will do it for us.
...
void SDL_AppQuit(void *appstate, SDL_AppResult result)
{
    ...
    if (iocooked)
    {
        SDL_CloseIO(iocooked);
    }
    if (iopostmix)
    {
        SDL_CloseIO(iopostmix);
    }
